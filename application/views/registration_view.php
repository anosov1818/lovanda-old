...
<option>Manx</option>
<option>Maori</option>
<option>Mauritian Creole</option>
<option>Middle English</option>
<option>Middle Low German</option>
<option>Mongolian</option>
<option>Norwegian</option>
<option>Old Armenian</option>
<option>Old English</option>
<option>Old French</option>
<option>Old Javanese</option>
<option>Old Norse</option>
<option>Old Prussian</option>
<option>Oriya</option>
...
<option>Proto-Slavic</option>
<option>Quenya</option>
...
<option>Upper Sorbian</option>
<option>Urdu</option>
<option>Uyghur</option>
<option>Uzbek</option>
<option>Venetian</option>
<option>Vietnamese</option>
<option>Vilamovian</option>
<option>Volapük</option>
<option>Võro</option>
<option>Welsh</option>
<option>Xhosa</option>
<option>Yiddish</option>
<option>Zazaki</option>
<option>other</option>
  </select>
